...
class App extends React.Component {
    ...
    render() {
        return (
            <div className="App">
                <a-scene embedded arjs="sourceType: webcam;" inspector="" keyboard-shortcuts="" screenshot="" vr-mode-ui="" aframe-inspector-removed-embedded="undefined"><canvas className="a-canvas" data-aframe-canvas="true" width="300" height="150"></canvas>
                <a-assets>
